...
class SchemaProposal(BaseModel):
    """Structured dataset schema proposal.

    Generated by the agent when a user asks to propose a schema,
    pipeline configuration, and quality gates for a dataset.
    """

    dataset_name: str
    num_files_sampled: int
    columns: list[dict]  # [{name, dtype, nullable, description}]
    pipeline_config: dict  # suggested Pipeline kwargs
    quality_gates: dict  # suggested filoma-gates.yml contents
    issues: list[str]  # issues found during inspection
    recommendations: list[str]
