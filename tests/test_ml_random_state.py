...
def test_deterministic_with_same_seed():
    ...
    out1 = auto_split(df, train_val_test=(70, 15, 15), feature="path_parts", path_parts=(-2,), seed=42)
    out2 = auto_split(df, train_val_test=(70, 15, 15), feature="path_parts", path_parts=(-2,), seed=42)
    assert _collect_paths(out1) == _collect_paths(out2)


def test_random_state_overrides_seed():
    df = _make_df(n_groups=8, per_group=5)
    out_seed = auto_split(df, train_val_test=(70, 15, 15), feature="path_parts", path_parts=(-2,), seed=1)
    out_random = auto_split(df, train_val_test=(70, 15, 15), feature="path_parts", path_parts=(-2,), seed=1, random_state=7)
    out_effective = auto_split(df, train_val_test=(70, 15, 15), feature="path_parts", path_parts=(-2,), seed=7)
...
def test_different_seeds_produce_different_splits():
    df = _make_df(n_groups=8, per_group=5)
    out1 = auto_split(df, train_val_test=(70, 15, 15), feature="path_parts", path_parts=(-2,), seed=2)
    out2 = auto_split(df, train_val_test=(70, 15, 15), feature="path_parts", path_parts=(-2,), seed=3)
    assert _collect_paths(out1) != _collect_paths(out2)
