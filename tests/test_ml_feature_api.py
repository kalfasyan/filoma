...
def test_path_parts_negative_and_positive_indices():
    ...
    t1, v1, te1 = ml.auto_split(df, train_val_test=(60, 20, 20), feature="path_parts", path_parts=(-1,), path_col="path", seed=1)
    # Use positive index 4 (0-based parts: ['root','a','b','c','file1.txt'])
    t2, v2, te2 = ml.auto_split(df, train_val_test=(60, 20, 20), feature="path_parts", path_parts=(4,), path_col="path", seed=1)
...
def test_feature_preview_columns_added():
    ...
    # path_parts preview
    tr, va, te = ml.auto_split(df, train_val_test=(60, 20, 20), feature="path_parts", path_parts=(-1,), path_col="path", seed=0)
    ...
    tr2, _, _ = ml.auto_split(df2, train_val_test=(60, 20, 20), feature="token1", path_col="path", seed=0)
